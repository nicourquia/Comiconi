...
const joker = "https://i.pinimg.com/originals/a6/ab/8a/a6ab8aa97ca64923fbaeb172d79ea4ed.png"


function CheckOut() {
    document.title = `Comiconi Finalizar Compra`;
      ...
      <div
        ...
        if (cart.length === 0) {
            ...
            <div className="row py-lg-5">
                ...
                <img src={joker} width="250" alt="habemus" className="img-fluid" />
                <p></p>
  ...
  return (
    ...
    <main>
      <div className="py-3 text-center">
        ...
        <p className="lead">Complete con sus datos personales para realizar el pago</p>
      </div>
